/*************************************************************************
    @ File Name: CircleLayoutTest.java
    @ Author: King
    @ Mail: arturiapendragon_1@163.com 
    @ Created Time: 2018年01月25日 星期四 18时39分57秒
 ************************************************************************/
...
class CircleLayout implements LayoutManager
{
	...
	public void setSizes(Container parent)
	{
		...
		for (int i = 0; i < n; i++)
		{
			...
			if (c.isVisible())
			{
				...
				preferreWidth += d.width;
				preferredHeight += d.height;
			}
		}
		minWidth = preferreWidth / 2;
	...
	public Dimension preferredLayoutSize(Container parent)
	{
		...
		int width = preferreWidth + insets.left + insets.right;
