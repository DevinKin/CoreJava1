/*************************************************************************
    ...
    @ Created Time: 2018年01月26日 星期五 17时38分13秒
 ************************************************************************/
...
class ImageViewerFrame extends JFrame
{
	public ImageViewerFrame()
	{
		...
		// accpet all image files ending with .jpg, .jpeg, .gif
		/*
		final ExtensionFileFilter filter = new ExtensionFileFilter();
		filter.addExtension("jpg");
		filter.addExtension("jpeg");
		filter.addExtension("gif");
		fliter.setDescription("Image files");
		*/
...
/**
 * A file view that displays an icon for all files taht match a file filter.
 */
